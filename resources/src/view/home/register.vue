            ...
            <el-col :xs="{span: 20, offset:2}" :sm="{span:20, offset:2}"
                ...
                <el-form ref="form" :model="form" label-position="left" label-width="70px">
                    ...
                    <el-form-item label="账号">
                        <el-input class="define" v-model="form.name" auto-complete="off" placeholder="用户名"></el-input>
                    </el-form-item>

                    <el-form-item label="密码" prop="pass">
                        <el-input class="define" type="password" v-model="form.password" auto-complete="off" placeholder="输入密码"></el-input>
                    </el-form-item>
                    <el-form-item label="确认密码" prop="pass">
                        <el-input class="define" type="password" v-model="form.password_confirmation"
                                  auto-complete="off" placeholder="确认密码"
                        ></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱">
                        <el-input class="define" v-model="form.email" auto-complete="off" placeholder="请填写有效邮箱"></el-input>
                    </el-form-item>
                </el-form>
            </el-col>
            <el-col :xs="{span: 20, offset:2}" :sm="{span:20, offset:2}" :md="{span:4, offset:10}" class="content">
                <el-button type="success" class="register"
                           style="margin-left: 0;" @click.native="register()">注册</el-button>
            </el-col>
        </el-row>
    </div>
</template>
<script>
    ...
    export default{
        ...
        methods : {
            register () {
               this.$https.post('register', this.form).then(
                   response => {
...
<style>
    #register.content-wrapper{
        height: 100%;
        background: url("../../assets/pp.png") no-repeat center;
